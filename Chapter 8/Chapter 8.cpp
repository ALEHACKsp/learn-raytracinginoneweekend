...
int main()
{
	...
	list[2] = new sphere(vec3(1., 0., -1.0), 0.5, new metal(vec3(0.8, 0.6, 0.2), 1.0));
	list[3] = new sphere(vec3(-1., 0., -1.0), 0.5, new metal(vec3(0.8, 0.8, 0.8), 0.3));
